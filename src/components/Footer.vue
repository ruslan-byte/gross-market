...
<script>
	...
	export default {
		...
		data(){
			return{
				isOpenInformationPopup:false,
			}
		},
		methods:{
			openInformationPopup(){
				this.isOpenInformationPopup = true;
			}
		}
	}
</script>
